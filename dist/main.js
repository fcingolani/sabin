...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ga = __webpack_require__(110);
	...
	var _CalendarPage = __webpack_require__(128);
	...
	router.map({
	  ...
	  '/calendar/:country/:birthDate': {
	    name: 'calendar',
	    component: _CalendarPage2.default
	  }

	});

	router.afterEach(function (transition) {
	  (0, _ga2.default)('set', 'page', transition.to.path);
...
/***/ function(module, exports, __webpack_require__) {
	...
	_jquery2.default.extend(_jquery2.default.fn.pickadate.defaults, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = Vue;
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }()), __webpack_require__(108)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "F:\\White Duke\\Sandbox\\sabin\\src\\pages\\HomePage.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./HomePage.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./HomePage.vue");
	...
	exports.default = {
	  ...
	  computed: {
	    countries: function countries() {
	      return _underscore2.default.map(_calendar2.default, function (value, key, list) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _chile = __webpack_require__(126);
...
/***/ function(module, exports) {
	...
	module.exports = {
		...
		"vaccines": [
			{
				"name": "BCG",
				"protectsFrom": "Tuberculosis (formas invasivas)",
				"doses": [
					{
						"title": "Única dosis",
						"description": "Antes de egresar de la maternidad",
						"from": {
							"days": 0
						}
					}
			...
			{
				"name": "Hepatitis B (HB)",
				"protectsFrom": "Hepatitis B",
				"doses": [
					{
						"title": "Dosis neonatal",
						"description": "En las primeras 12 horas de vida",
						"from": {
							"days": 0
						}
					},
					{
						"title": "1ª dosis",
						"description": "Vacunación Universal: Si no hubiera recibido el esquema completo, deberá completarlo. En caso de tener que iniciar: aplicar 1ª dosis, 2ª dosis al mes de la primera y 3ª dosis a los seis meses de la primera.\n",
						"from": {
							"years": 11
						}
					},
			...
			},
			{
				...
				"protectsFrom": "Meningitis, neumonía y sepsis por neumococo",
				"doses": [
					{
						"title": "1ª dosis",
						"from": {
			...
			},
			{
				...
				"protectsFrom": "Difteria, tétanos, tos convulsa, Hep B, Haemophilus influenzae b",
				"doses": [
					{
						"title": "1ª dosis",
						"from": {
			...
			},
			{
				...
				"doses": [
					...
					{
						"title": "2º Refuerzo",
						"description": "Al ingresar a 1er grado de Primaria",
						"atSchool": true,
						"from": {
							"years": 6
						}
			...
			{
				"name": "Rotavirus",
				"protectsFrom": "Rotavirus",
				"doses": [
					{
						"title": "1ª dosis",
						"description": "La primera dosis debe administrarse antes de las 14 semanas y 6 días o tres meses y medio.\n",
						"from": {
							"months": 2
						}
					},
					{
						"title": "2ª dosis",
						"description": "La segunda dosis debe administrarse antes de las 24 semanas o los 6 meses de vida.\n",
						"from": {
							"months": 4
						}
					}
			...
			},
			{
				...
				"doses": [
					{
						"title": "Dosis anual",
						"description": "Deberán recibir en la primovacunación 2 dosis de vacuna separadas al menos por 4 semanas.\n",
						"from": {
							"months": 6
						},
						"to": {
			...
			},
			{
				...
				"protectsFrom": "Sarampión, rubéola, paperas.",
				"doses": [
					{
						"title": "1ª dosis",
						"from": {
			...
			{
				"name": "Cuádruple o Quíntuple Pentavalente (DTP-Hib)",
				"protectsFrom": "Difteria, tétanos, tos convulsa, Haemophilus influenzae b.",
				"doses": [
					{
						"title": "1º refuerzo",
						"from": {
			...
			},
			{
				...
				"protectsFrom": "Difteria, tétanos, tos convulsa",
				"doses": [
					{
						"title": "2º refuerzo",
						"description": "Al ingresar a 1er grado de Primaria",
			...
			{
				"name": "Fiebre Amarilla (FA)",
				"warning": "Sólo para residentes en zona de riesgo.",
				"protectsFrom": "Fiebre Amarilla",
				"doses": [
					{
						"title": "1ª dosis",
						"from": {
			...
			{
				"name": "Fiebre Hemorrágica Argentina (FHA)",
				"warning": "Sólo para residentes en zona de riesgo.",
				"protectsFrom": "Fiebre Hemorrágica Argentina",
				"doses": [
					{
						"title": "Única dosis",
						"from": {
...
/***/ function(module, exports) {
	...
	module.exports = {
		...
		"country": "Chile",
		"updated_at": "2016-05-27T00:00:00.000Z",
		"source": "http://vacunas.minsal.cl/?page_id=1539",
		"education": {
			"classStartMonth": 4,
			"termStartMonth": 3
		},
		"vaccines": [
			{
				"name": "BCG",
				"protectsFrom": "Enfermedades invasoras por M. tuberculosis",
				"doses": [
					{
						"title": "Única dosis",
						"description": "Antes de egresar de la maternidad",
			...
			},
			{
				...
				"protectsFrom": "Enfermedades invasoras por S. pneumoniae",
				"doses": [
					{
						"title": "1ª dosis",
						"from": {
					...
					{
						"title": "Refuerzo",
						"description": "Sólo para prematuros",
						"from": {
							"months": 6
						}
					},
			...
			{
				"name": "Pentavalente",
				"protectsFrom": "Hepatitis B, Difteria, Tétanos, Tos Convulsiva, Enfermedades invasoras por H. influenzae tipo b (Hib)",
				"doses": [
					{
						"title": "1ª dosis",
						"from": {
			...
			{
				"name": "Hepatitis A",
				"warning": "Solo para la región de Arica y Parinacota, Tarapacá y algunas comunas de Biobio.",
				"protectsFrom": "Hepatitis A.",
				"doses": [
					{
						"title": "Única dosis",
			...
			{
				"name": "Meningocócica Conjugada",
				"protectsFrom": "Enfermedades invasoras por N. meningitidis.",
				"doses": [
					{
						"title": "Única dosis",
						"from": {
			...
			{
				"name": "Neumocócica Polisacárida",
				"protectsFrom": "Enfermedades invasoras por S. pneumoniae.",
				"doses": [
					{
						"title": "Única dosis",
						"description": "Adultos de 65 años y más",
						"from": {
							"years": 65
						}
					}
			...
			{
				"name": "dTp (acelular)",
				"protectsFrom": "Difteria, Tétanos, Tos Convulsiva",
				"doses": [
					{
						"title": "1ª dosis",
						"description": "1º Básico",
			...
			{
				"name": "VPH",
				"protectsFrom": "Infecciones por Virus Papiloma Humano.",
				"warning": "Sólo niñas.",
				"doses": [
					{
						"title": "1ª dosis",
						"description": "4º Básico",
						"atSchool": true,
						"from": {
							"years": 9
						}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "F:\\White Duke\\Sandbox\\sabin\\src\\pages\\CalendarPage.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./CalendarPage.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./CalendarPage.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DoseCard = __webpack_require__(170);

	var _DoseCard2 = _interopRequireDefault(_DoseCard);

	var _ImportDialog = __webpack_require__(175);
	...
	exports.default = {
	  ...
	  components: {
	    DoseCard: _DoseCard2.default,
	    ImportDialog: _ImportDialog2.default
	  },
	  ...
	  ready: function ready() {
	    ...
	    (0, _jquery2.default)('.tabs a').each(function (i, el) {
	      (0, _jquery2.default)(el).off('click');
	    });
	  ...
	  computed: {
	    ...
	    doses: function doses() {
	      ...
	      try {
	        for (var _iterator = (0, _getIterator3.default)(this.calendar.vaccines), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	          var vaccine = _step.value;
	          ...
	          try {
	            ...
	            for (var _iterator2 = (0, _getIterator3.default)(vaccine.doses), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	              var vaccineDose = _step2.value;


	              var dose = _underscore2.default.clone(vaccineDose);

	              dose.vaccine = vaccine;

	              if (vaccineDose.atSchool) {

	                var lateSchool = this._birthDateMoment.month() < this.calendar.education.classStartMonth - 1;

	                dose.from = (0, _moment2.default)({
	                ...
	                dose.from = (0, _moment2.default)(this._birthDateMoment).add(vaccineDose.from);

	                if (vaccineDose.to) {
	                  dose.to = (0, _moment2.default)(this._birthDateMoment).add(vaccineDose.to);
	                }
	              }
	      ...
	      return _underscore2.default.sortBy(doses, function (dose) {
	    ...
	    futureDoses: function futureDoses() {
	      ...
	      return _underscore2.default.filter(this.doses, function (dose) {
	  ...
	  methods: {
	    showModal: function showModal(id) {
	      (0, _jquery2.default)('#' + id).openModal();
	    }
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(151)(IteratorPrototype, __webpack_require__(159)('iterator'), function(){ return this; });
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(147).getIterator = function(it){
	  var iterFn = get(it);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "F:\\White Duke\\Sandbox\\sabin\\src\\components\\DoseCard.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./DoseCard.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./DoseCard.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
	...
	exports.default = {
	  ...
	  filters: {
	    ...
	    relative: function relative(date) {
	      ...
	      var today = (0, _moment2.default)({ hour: 0 });

	      var duration = _moment2.default.duration(date.diff(today));
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "F:\\White Duke\\Sandbox\\sabin\\src\\components\\ImportDialog.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./ImportDialog.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./ImportDialog.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _gapiPromise = __webpack_require__(179);
	...
	exports.default = {
	  ...
	  ready: function ready() {
	    ...
	    _gapiPromise2.default.then(function (gapi) {
	  ...
	  methods: {
	    ...
	    save: function save() {
	      ...
	      _gapiPromise2.default.then(function (gapi) {
	        ...
	        gapi.client.calendar.calendars.insert({
	          ...
	          var calendar = response.result;

	          var batch = gapi.client.newBatch();

	          _underscore2.default.each(that.doses, function (dose) {

	            var description = [dose.description, dose.vaccine.description, 'Protege contra: ' + dose.vaccine.protectsFrom, dose.vaccine.warning];
	    ...
	    handleLogin: function handleLogin(response) {
	      var that = this;
